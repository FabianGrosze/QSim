...
!! @date 23.01.1994
subroutine trimat_z(a, b, c, dT, doo, dN4, dN2, dN3, dP, dSi, dKi, dGr, dBl,  &
                    dChl, dCChlk, dCChlb, dCChlg, dchlk, dchlg, dchlb, dgesP, &
                    dgesN, dQ_NKz, dQ_NBz, dQ_NGz, tempwz, vo2z, vNH4z, vNO2z,&
                    vNO3z, gelPz, Siz, akiz, agrz, ablz, chlaz, hchlkz,       &
                    hchlgz, hchlbz, hgesPz, hgesNz, hQ_NKz, hQ_NBz, hQ_NGz,   &
                    hCChlkz, hCChlbz, hCChlgz, Qmx_NK, Qmx_NB, Qmx_NG, nkzs,  &
                    mstr, ior, azStrs)
   ! Koeffizienten: a,b,c
   integer                           :: azStrs
