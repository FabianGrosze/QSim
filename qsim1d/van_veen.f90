...
!> Berechnung eines vertikalen Geschwindigkeitsprofils
!! @author Volker Kirchesch
!! @date 04.01.2005
subroutine van_veen(rau, tiefe, hvmitt, nkzs, dH2D, zf, xU, dvdz, WGe, IDWe,  &
                    mstr, ior, hconus, hconub, Uvert, Wlage, hWS, i_windP, azStrs)
