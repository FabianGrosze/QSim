...
subroutine EreigGParam(cpfad1)
   ...
   write(1, '(A)') '  <Parameter Ident="gsPb" Text="Blei-ges." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="999999.99" Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glPb" Text="Blei-gel." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="99999.99"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsCad" Text="Cadmium-ges." IsLoad="0" Unit="µg/l" Format="F8.4" Null="-1" Help="" Min="0.0001" Max="999.9999"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glCad" Text="Cadmium-gel." IsLoad="0" Unit="µg/l" Format="F8.4" Null="-1" Help="" Min="0.0001" Max="999.9999"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsCr" Text="Chrom-ges." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="999999.99" Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glCr" Text="Chrom-gel." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="99999.99"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsFe" Text="Eisen-ges." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glFe" Text="Eisen-gel." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsCu" Text="Kupfer-ges." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glCu" Text="Kupfer-gel." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsMn" Text="Mangan-ges." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="999999.99" Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glMn" Text="Mangan-gel." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="99999.99"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsNi" Text="Nickel-ges." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glNi" Text="Nickel-gel." IsLoad="0" Unit="µg/l" Format="F7.3"  Null="-1" Help="" Min="0.001"  Max="999.999"   Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsHg" Text="Quecksilber-ges." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="999999.99" Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glHg" Text="Quecksilber-gel." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="99999.99"  Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="gsU" Text="Uran-ges." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="999999.99" Default="" Module="Schwer" />'
   write(1, '(A)') '  <Parameter Ident="glU" Text="Uran-gel." IsLoad="0" Unit="µg/l" Format="F9.2"  Null="-1" Help="" Min="0.01"   Max="99999.99"  Default="" Module="Schwer" />'
