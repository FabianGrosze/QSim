...
!
 ...
 i_zaehlv = 1   
  ...
  i_zaehlv = i_zaehlv+1
   ...
   if(i_zaehlv<=24)then 
     call lin_interpolation1(y_var,y_var_neu,hctiefe_neu,tiefe_neu,nkzs_alt, nkzs_neu,i_zaehlv,itags,monats,mstr,ior)
   endif
...
!
!***************************************
 subroutine lin_interpolation1(y_var,y_var_neu,hctiefe_neu,tiefe_neu,nkzs_alt, nkzs_neu,i_zaehlv,itags,monats,mstr,ior)
!
...
!         if(mstr==6.and.i_zaehlv==12)write(89,'(i4,2x,i2,2x,I2,2x,f10.7,2x,f10.7,2x,f10.7)')ior,nkz_alt,nkz,tiefe_neu(nkz),hcTiefe_neu(nkz_alt)
 ...
 end subroutine lin_interpolation1   
!******************************************
