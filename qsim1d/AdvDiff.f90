...
!  endif 
  ...
  subroutine Crank_Nicolson(U,elen,flag,dl,deltat,anze,temp0,icraNicKoeff,ithomas,mstr,ktrans,iwahlD,nkz,nkzs       &
    ...
    if(icraNicKoeff==0)call cra_NicKoeff(elen,r1,r2,r3,dl,flag,deltat,anze,nkzs,nkz,mstr,ktrans,imarker,icraNicKoeff,itags,uhrz)
...
! #####TRIMAT.....TRIMAT.....TRIMAT.....TRIMAT.....TRIMAT########################
...
!     *******************************************************
!     * A SUBROUTINE FOR CALCULATING 1-D ADVECTION EQUATION *
!     * BASED ON AN CUBIC INTERPOLATION.                    *
!     *******************************************************
    integer :: NX, I, azStrs
...
!      endif 
    ...
    subroutine quickest(U, vmitt, Uvert, dx, DeltaT, nx, flag, ktrans,mstr, nkz, nkzs, iwahlD, isgn, Uhrz, itags, monats, itime,iwsim)
