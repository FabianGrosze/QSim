...
!! Details dazu in: \subpage wetter_rb \n
!!
...
if(meinrang.ne.0)then ! alle Prozesse ausser 0
      ...
      if(alloc_status.ne.0) call qerror('allocate zone failed in zonen_parallel() zonen.f95')
...
!!\n\n
!! aus Datei zonen.f95 ; zurück zu \ref Datenmodell oder \ref lokaleParameter

!
!----+-----+----
!> Dient der eingabe() von MODELLG.3D.txt. \n siehe \ref qsimdateimodellg3 \n
!! \n\n aus zonen.f95 , zurück: \ref Datenmodell
      SUBROUTINE modellg()
      use modell
      implicit none
