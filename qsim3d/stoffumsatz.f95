...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Stoffumsätze parallelisiert
      do i=1,part ! Alle Knoten auf diesem Prozessor 
         ...
         if(nur_alter) then
            call alter(i)
            if(iglob.eq.kontrollknoten) print*,'stoffumsatz: nur aufenthaltszeit (alter)'
         ...
         if(iglob.eq.kontrollknoten) print*,'stoffumsatz: bac(1) vor orgc_huelle = '  &
