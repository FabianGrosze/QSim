...
!! @date 05.07.1993
subroutine pwert(mws,vphs,lfs,tempws,pws)
   implicit none
   
   real     :: mws, vphs, lfs, tempws, pws
   real     :: K1,K2,MUE,lgk1,lgk2,lgh,lgoh, abst, pk1, pk2, pkw, hk
   real     :: c, ph0, ph1, ph2, delph, delph1, delph2
   ...
   delph1 = vphs -ph1
   itera = itera+1
   if (abs(delph1) < 0.02 .or. itera > 500) goto 20
   if (delph1 < 0.0) then
      pws = pws -0.000005
      goto 5
   endif
