...
!! @date 24.08. 2011
subroutine silikat(si, flag, elen, ior, esi, qeinl, vabfl, anze, tflie, jiein,&
                   aki, albewk, alberk, tiefe, tempw, ilbuhn, akkssi, Qmx_SK, &
                   Q_SK, up_Siz, Siz, algakz, akitbr, akibrz, hJSi, nkzs,     &
                   dH2D, dH2De, mstr, iorLa, iorLe, ieinLs, flae, qeinlL, SiL,&
                   itags, Uhrz, azStrs,                                       &
                   kontroll,jjj)
