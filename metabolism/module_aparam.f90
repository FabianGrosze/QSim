...
subroutine AParamParam(cpfad1)
   ...
   write(200, '(A)') '  <Parameter Ident="b_Zn" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Zn" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Zink" />'
   write(200, '(A)') '  <Parameter Ident="b_Cd" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Cd" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Cadmium" />'
   write(200, '(A)') '  <Parameter Ident="b_Cu" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Cu" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Kupfer" />'
   write(200, '(A)') '  <Parameter Ident="b_Ni" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Ni" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Nickel" />'
   write(200, '(A)') '  <Parameter Ident="b_As" Text="Einflussparameter Salinität auf Verteilungskoeffizient für As" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Arsen" />'
   write(200, '(A)') '  <Parameter Ident="b_Pb" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Pb" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Blei" />'
   write(200, '(A)') '  <Parameter Ident="b_Cr" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Cr" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Chrom" />'
   write(200, '(A)') '  <Parameter Ident="b_Fe" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Fe" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Eisen" />'
   write(200, '(A)') '  <Parameter Ident="b_Hg" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Hg" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Quecksilber" />'
   write(200, '(A)') '  <Parameter Ident="b_Mn" Text="Einflussparameter Salinität auf Verteilungskoeffizient für Mn" Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Mangan" />'
   write(200, '(A)') '  <Parameter Ident="b_U"  Text="Einflussparameter Salinität auf Verteilungskoeffizient für U"  Unit="-" Format="F7.3" Null="-1" Help="-" Default="282." Min="-99.999" Max="99.999" Gruppe="Schwermetalle" Kategorie="Uran" />'
