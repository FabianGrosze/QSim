...
subroutine AParamParam(cpfad1)
  ...
  call version_string(versionstext)
   ...
   write(200, '(A)') '  <Parameter Ident="CSBKI" Text="CSB-Erhöhung Kieselalgen" Unit="mg/mgC" Format="F6.4" Null="-1" Help="" Default="3.1" Min="1.0" Max="9.9999" Gruppe="Kieselalgen" Kategorie="C Biomasse" />'
