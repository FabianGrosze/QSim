...
!>                                      global parameter from APARAM.txt
      ...
      real :: opkima,askie,ToptK,kTemp_Ki
	  ! Blaualgen
	  real :: abchl,abgmax,IKbe,abksn,abksp,abremi,frmube,bsbbl,csbbl  &
	         ,Qmx_NB,Qmx_PB,Qmn_NB,Qmn_PB,upmxNB,upmxPB,opblmi,opblma,asble,ToptB,kTemp_bl
	  integer :: ifix
	  ! Rotatorien
      real :: IRMAX,FOPTR,GROT,ZRESG,ZAKI,ZAGR,ZABL
      !real :: irmaxe,FopIRe,GRote,zresge,zakie,zagre,zable
	  ! Nitrosomonas
	  real :: YNMAX1,STKS1,ANITR1,BNMX1,BNKS1
	  !real :: ynmx1e,stks1e,anitrie,bnmx1e,bnks1e
	  ! Nitrobacter
	  real :: YNMAX2,STKS2,ANITR2,BNMX2,BNKS2
	  !real :: ynmx2e,stks2e,anitri2e,bnmx2e,bnks2e
	  ! Sediment-Flux
	  real :: KNH4,KapN3,  fPOC1,fPOC2,SorpCap,Klang,KdNh3
	  !real :: KNH4e,KapN3e,  fPOC1e,fPOC2e,SorpCape,Klange,KdNh3e
	  ! Kohlenstoff
	  real :: HyP1,hymxD,KsD1,KsD2,KsM,upBAC,YBAC,rsGBAC
	  !real :: hyPe,hymxDe,KsD1e,KsD2e,KsMe,upBACe,YBACe,rsGBACe
	  ! Muscheln
	  real :: FoptD
	  !real :: FoptDe
	  ! HNF
      ...
      real :: alamda
	  !Hygiene
	  real :: ratecd,etacd,rateci,xnuec,ratecg,ratecs
	  !real :: ratecde,etacde,ratecie,xnuece,ratecge,ratecse
	  ! Schwermetalle
...
!! Quelle: module_aparam.f90
	  ...
	  integer iwsim,icoli,ifehl,ieros
	  ...
	  namelist /ALGAE/  &
               AGCHL,AGGMAX,IKge,AGKSN,AGKSP,AGREMI,frmuge,BSBGR,CSBGR,QMX_NG,QMX_PG,QMN_NG,QMN_PG  &
              ,UPMXNG,UPMXPG,OPGRMI,OPGRMA,ASGRE,TOPTG,KTEMP_GR  &
	          ,AKCHL,AKGMAX,IKke,AKKSN,AKKSP,AKKSSI,AKREMI,frmuke,BSBKI,CSBKI,QMX_NK,QMX_PK,QMX_SK  &
	          ,QMN_NK,QMN_PK,QMN_SK,UPMXNK,UPMXPK,UPMXSK,OPKIMI,OPKIMA,ASKIE,TOPTK,KTEMP_Ki  &
	          ,ABCHL,ABGMAX,IKbe,ABKSN,ABKSP,ABREMI,frmube,BSBBL,CSBBL,QMX_NB,QMX_PB,QMN_NB,QMN_PB  &
			  ,UPMXNB,UPMXPB,OPBLMI,OPBLMA,ASBLE,TOPTB,KTEMP_Bl,ifix
	  ...
	  namelist /Schwermetalle/c1Pb,e1Pb,c2Pb,e2Pb,c3Pb,e3Pb,c4Pb,e4Pb,c5Pb,e5Pb,VTKoeffDe_Pb,  &
      ...
      ! write Example
      write(dateiname,'(2A)')trim(adjustl(cpfad)),'APARAM_example.nml'
...
!      if(io_error.eq.0)then ! APARAM.nml exists
      if(.false.)then ! not yet operational
         rewind (55)
         read(55,nml=ALGAE,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist ALGAE went wrong'
         read(55,nml=Rotatorien,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Rotatorien went wrong'
		 print*,'Rotatorien: =IRMAX,FOPTR,GROT,ZRESG',IRMAX,FOPTR,GROT,ZRESG
         read(55,nml=Nitrosomonas,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Nitrosomonas went wrong'
		 ...
		 if(io_error.ne.0)print*,'reading namelist Nitrobacter went wrong'
         read(55,nml=Kohlenstoff,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Kohlenstoff went wrong'
         read(55,nml=Muscheln,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Muscheln went wrong'
         read(55,nml=HNF,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist HNF went wrong'
         read(55,nml=Wasser,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Wasser went wrong'
         read(55,nml=Sediment,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Sediment went wrong'
         read(55,nml=Hygiene,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Hygiene went wrong'
         read(55,nml=Schwermetalle,iostat=io_error)
		 if(io_error.ne.0)print*,'reading namelist Schwermetalle went wrong'
         close (55) 
		 ...
		 summ_err=0
!........APARAM.txt                                                         
         write(dateiname,'(2A)')trim(adjustl(cpfad)),'APARAM.txt'
         open(unit=55, file=dateiname, status ='old', action ='read ', iostat = io_error )
         ...
         rewind (55) 
         ! Zeile 01 ...
         read(55,*,iostat=io_error)agchl,aggmax,IKge,agksn,agksp			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)agremi,frmuge,bsbgr,csbgr,Qmx_NG			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)Qmx_PG,Qmn_NG,Qmn_PG,upmxNG,upmxPG		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)opgrmi,opgrma,asgre,ToptG,kTemp_Gr		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)akchl,akgmax,IKke,akksn,akksp			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)akkssi,akremi,frmuke,bsbki,csbki			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)Qmx_NK,Qmx_PK,Qmx_SK,Qmn_NK,Qmn_PK		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)Qmn_SK,upmxNK,upmxPK,upmxSK,opkimi		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)opkima,askie,ToptK,kTemp_Ki,abchl		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)abgmax,IKbe,abksn,abksp,abremi			; if(io_error.ne.0)summ_err=summ_err+1
         ! Zeile 11 ...
         read(55,*,iostat=io_error)frmube,bsbbl,csbbl,Qmx_NB,Qmx_PB			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)Qmn_NB,Qmn_PB,upmxNB,upmxPB,opblmi		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)opblma,asble,ToptB,kTemp_Bl,ifix			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)IRMAX,FOPTR,GROT,ZRESG,ZAKI			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)ZAGR,ZABL,YNMAX1,STKS1,ANITR1		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)BNMX1,BNKS1,YNMAX2,STKS2,ANITR2		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)BNMX2,BNKS2,KNH4,KapN3,HyP1			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)hymxD,KsD1,KsD2,KsM,upBAC			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)YBAC,rsGBAC,FoptD,upHNF,BACks		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)alamda,fPOC1,fPOC2,SorpCap,Klang		; if(io_error.ne.0)summ_err=summ_err+1
         ! Zeile 21 ...
         read(55,*,iostat=io_error)KdNh3,ratecd,etacd,rateci,xnuec		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)ratecg,ratecs,dummy,c1Pb,e1Pb	        ; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c2Pb,e2Pb,c3Pb,e3Pb,c4Pb					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e4Pb,c5Pb,e5Pb,VTKoeffDe_Pb,c1Cad 		; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e1Cad,c2Cad,e2Cad,c3Cad,e3Cad			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c4Cad,e4Cad,c5Cad,e5Cad,VTKoeffDe_Cad	; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c1Cr,e1Cr,c2Cr,e2Cr,c3Cr					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e3Cr,c4Cr,e4Cr,c5Cr,e5Cr					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)VTKoeffDe_Cr,c1Fe,e1Fe,c2Fe,e2Fe			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c3Fe,e3Fe,c4Fe,e4Fe,c5Fe					; if(io_error.ne.0)summ_err=summ_err+1
         ! Zeile 31 ...
         read(55,*,iostat=io_error)e5Fe,VTKoeffDe_Fe,c1Cu,e1Cu,c2Cu			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e2Cu,c3Cu,e3Cu,c4Cu,e4Cu					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c5Cu,e5Cu,VTKoeffDe_Cu,c1Mn,e1Mn			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c2Mn,e2Mn,c3Mn,e3Mn,c4Mn					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e4Mn,c5Mn,e5Mn,VTKoeffDe_Mn,c1Ni			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e1Ni,c2Ni,e2Ni,c3Ni,e3Ni					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c4Ni,e4Ni,c5Ni,e5Ni,VTKoeffDe_Ni			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c1Hg,e1Hg,c2Hg,e2Hg,c3Hg					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e3Hg,c4Hg,e4Hg,c5Hg,e5Hg					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)VTKoeffDe_Hg,c1U,e1U,c2U,e2U				; if(io_error.ne.0)summ_err=summ_err+1
         ! Zeile 41 ...
         read(55,*,iostat=io_error)c3U,e3U,c4U,e4U,c5U						; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e5U,VTKoeffDe_U,c1Zn,e1Zn,c2Zn			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e2Zn,c3Zn,e3Zn,c4Zn,e4Zn					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c5Zn,e5Zn,VTKoeffDe_Zn,c1As,e1As			; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)c2As,e2As,c3As,e3As,c4As					; if(io_error.ne.0)summ_err=summ_err+1
         read(55,*,iostat=io_error)e4As,c5As,e5As,VTKoeffDe_As				; if(io_error.ne.0)summ_err=summ_err+1

         close (55) 
	  endif ! namelist
	  
	  ! check 
	  if (summ_err.gt. 0)then
      ...
      if(icoli/=1)then 
         if(IKge<0.0 .or. IKke<0.0 .or. KNH4<0.0 .or. KapN3<0.0 .or. HyP1<0.0 .or. ToptG<0.0 .or. Klang<0.0 .or. ifix.lt.0)then                                
            ifehl = 3 
            RETURN 
         endif 
...
!----+-----+----
!> Die suboutine AParamParam()
!! dient der Ausgabe der Definition von AParam
...
!  Ausgabe der Definition von AParam
  ...
  write(pfadstring,'(2A)')trim(adjustl(cpfad1)),'AParamParam.xml'
  print*,'AParamParam: pfadstring',trim(adjustl(pfadstring))
  open(unit=200, file=pfadstring)
  
  WRITE(200, '(A)')'<?xml version="1.0" encoding="ISO-8859-1" standalone="yes"?>'
  WRITE(200, '(A)') '<GerrisParam FileType="AParam" QsimVersion="14.08">'  
